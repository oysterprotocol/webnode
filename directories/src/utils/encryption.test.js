...
test("nodeForge encryption should produce the expected results", done => {
  for (let i = 0; i < encryptionTestCases.length; i++) {
    let result = Encryption.forgeEncrypt(
...
test("nodeForge decryption should produce the expected results", done => {
  for (let i = 0; i < encryptionTestCases.length; i++) {
    let result = Encryption.forgeDecrypt(
      encryptionTestCases[i].key,
