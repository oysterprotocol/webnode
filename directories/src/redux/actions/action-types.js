...
export const IOTA_POW = "directories/iota/pow";
export const IOTA_POW_SUCCESS = "directories/iota/pow/success";
export const IOTA_COMPLETE = "directories/iota/pow/complete";
