...
const MiddleGroup = () => (
  <div style={styles.container}>
    ...
    <div style={styles.textDesktop}>
      ...
      from viewing certain content. <b><a style={styles.link}  target="_blank"  rel="noopener noreferrer" href="http://oysterprotocol.com">Learn more...</a></b>
    </div>
    <div style={styles.textMobile}>
      ...
      result in the web owner blocking certain content from view. <a style={styles.link} target="_blank" rel="noopener noreferrer" href="http://oysterprotocol.com">Learn more...</a>
    </div>
  </div>
);
